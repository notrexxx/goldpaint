 ...
 *
 */
class VentatotalesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tipopago' => ['type' => 'string', 'length' => 25, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'total' => 1,
            'cliente_id' => 1,
            'tipopago' => 'Lorem ipsum dolor sit a',
            'created' => '2016-03-13 05:21:48',
            'modified' => '2016-03-13 05:21:48'
        ],
    ];
}
